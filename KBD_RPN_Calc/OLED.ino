...
void Task_OLED(void *pvParameters)
{
  ...
  for (;;) // A Task shall never return or exit.
  {
    ...
    if ( dsp_start == 1 ) {
      ...
      display2.drawString( 0,                                                0, "Integer mode" );
      display2.drawString( 0,                      ( oled_height / 6 ) * 1 + 2, "1 : Hex" );
      display2.drawString( oled_width / 3,         ( oled_height / 6 ) * 1 + 2, "2 : Oct" );
      display2.drawString( ( oled_width / 3 ) * 2, ( oled_height / 6 ) * 1 + 2, "3 : Bin" );
      display.drawString(  0,                      ( oled_height / 6 ) * 1 + 2, "E : Dec" );

      display2.drawLine(   0, ( oled_height / 6 ) / 2 + ( oled_height / 6 ) * 2, oled_width,     ( oled_height / 6 ) / 2 + ( oled_height / 6 ) * 2 );
      display.drawLine(    0, ( oled_height / 6 ) / 2 + ( oled_height / 6 ) * 2, oled_width / 2, ( oled_height / 6 ) / 2 + ( oled_height / 6 ) * 2 );

      display2.drawString( 0,              ( oled_height / 6 ) * 3 - 2, "Real number mode" );
      display2.drawString( 0,              ( oled_height / 6 ) * 4, "1 : Sin" );
      display2.drawString( oled_width / 2, ( oled_height / 6 ) * 4, "2 : Cos" );
      display.drawString(  0,              ( oled_height / 6 ) * 4, "3 : Tan" );
      display2.drawString( 0,              ( oled_height / 6 ) * 5, "4 : arcSin" );
      display2.drawString( oled_width / 2, ( oled_height / 6 ) * 5, "5 : arcCos" );
      display.drawString(  0,              ( oled_height / 6 ) * 5, "6 : arcTan" );

      display.drawLine(   oled_width / 2,     0, oled_width / 2, oled_height );
      display.drawString( oled_width / 2 + 8, 0,                       ". : Reset" );
      display.drawString( oled_width / 2 + 8, ( oled_height / 5 ) * 1, "+ : x<->y" );
      display.drawString( oled_width / 2 + 8, ( oled_height / 5 ) * 2, "- : *10" );
      display.drawString( oled_width / 2 + 8, ( oled_height / 5 ) * 3, "* : CLR" );
      display.drawString( oled_width / 2 + 8, ( oled_height / 5 ) * 4, "/ : +/-" );
